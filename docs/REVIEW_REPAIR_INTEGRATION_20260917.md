...
Reviewed `build-host:/path/to/work/src/aii-voice-plugin`, branch
...
Integrated selected changes into `/path/to/work/voice-frontier`.
...
- Ubuntu 24.04 linux-test-host compiled and ran `pulse_refusal_test.c` with real libpulse
...
| Ubuntu 24.04 / Vulkan, shared linux-test-host | `linux-test-host:/path/to/work/repaired-vulkan-beta1-20260917-r2/run/result.json` | `deliverables/repaired-vulkan-beta1-20260917-r2/repair-audit.json` |
