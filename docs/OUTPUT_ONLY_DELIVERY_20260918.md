...
Ubuntu 24.04/linux-test-host and the Windows 11 VM/GTX 1070. Native tests passed 31/31,
...
- Ubuntu: linux-test-host `/path/to/work/voice-output-only-20260918/`.
- Windows: `C:\path\to\voice\voice-output-only-20260918\`.
