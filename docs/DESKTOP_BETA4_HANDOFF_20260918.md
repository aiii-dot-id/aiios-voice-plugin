...
Local handoff:
`/Volumes/AIII Models/work/voice-delivery-20260918/deliverables/output-only-beta4-signed-handoff-r1/`.
...
The existing authorized platform signer kept its private key on dev8.
...
`/Volumes/AIII Models/work/voice-delivery-20260918/test-results` plus its
