...
`dev8:/work/aiii/src/aii-voice-plugin`, without changing the host, SDK, installed
...
`/Volumes/AIII Models/work/voice-integration-20260917-r1/`.
...
landed to dev8 main; no GitHub push, catalog update, installation, signing,
