...
function(aii_map_source_path source replacement)
  ...
  foreach(path IN ITEMS "${spelling}" "${source}" "${resolved}")
    if(MSVC)
      # Keep the lexical spelling too: TO_NATIVE_PATH expands Windows 8.3
      # names, while __FILE__ may retain the short path supplied to the build.
      string(REPLACE "/" "\\" native_path "${path}")
